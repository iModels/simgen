...
class Project(object):
    ...
    def _init_renderer(self):
        self.renderer = Renderer(self.session, search_path=self.mixed_search_path)

    def find_file(self, file_name, implicit_ext=None):
        self.session.find_file(file_name, self.mixed_search_path, implicit_ext=implicit_ext)
